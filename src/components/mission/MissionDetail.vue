	...
	<div class="mission_div">
		...
		<div class="basic_div" v-if="active==1">
			...
			<div class="basic">
              ...
              <span class="channel_author" v-for="(item,index) in missionDetail.editors">
                {{item}}
					...
					<div class="basic_info_item">
						<span class="basic_info_name">责任编辑：</span>
						<span class="basic_info_value">{{missionDetail.signature}}</span>
					</div>
					<div class="basic_info_item">
						<span class="basic_info_name">关键词：</span>
			...
			<div class="channel">
              ...
              <img :src="missionDetail.channelProperty?missionDetail.channelProperty.coverImage:''"/>
            </span>
					</div>
					<div class="channel_info_item">
              ...
              <video>
              	<source :src="missionDetail.channelProperty?missionDetail.channelProperty.coverImage:''"></source>
              </video>
            </span>
					</div>
					<div class="channel_info_item">
